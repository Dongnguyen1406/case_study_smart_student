...
public class StudentDto { 
    ...
    public StudentDto(String studentId, String studentName, LocalDate dob, String gender, String address, String numberPhone, String email, String className, int classId) {
