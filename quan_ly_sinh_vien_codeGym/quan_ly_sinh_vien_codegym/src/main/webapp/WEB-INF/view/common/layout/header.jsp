...
<link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/view/admin/layout/style.css">
...
<nav class="navbar navbar-expand-lg shadow-sm" style="height: 70px; background-color: #ffffff">
    <div class="container-fluid d-flex justify-content-between align-items-center px-3">
        ...
        <div class="d-flex align-items-center">
            ...
            <!-- Tên người dùng -->
            <span class="fw-semibold text-dark me-3">Nguyễn Thị Thảo</span>
