...
<div id="sidebar" class="p-0 m-0 d-flex flex-column" style="height: 100vh; width: 250px; transition: width 0.3s; background-color: #ffffff">
    ...
    <ul class="nav flex-column px-2" id="sidebar-menu">
        ...
        <li class="nav-item d-flex align-items-center py-2">
            <a class="nav-link text-dark" href="${pageContext.request.contextPath}/view/user/student.jsp?page=score">
                <i class="bi bi-award fs-5"></i>
                <span class="ms-2 sidebar-text">Điểm</span>
            </a>
        </li>
        <li class="nav-item d-flex align-items-center py-2">
            <a class="nav-link text-dark" href="${pageContext.request.contextPath}/view/user/student.jsp?page=attendance">
                <i class="bi bi-calendar-check fs-5"></i>
                <span class="ms-2 sidebar-text">Điểm danh</span>
            </a>
        </li>
        <li class="nav-item d-flex align-items-center py-2">
            <a class="nav-link text-dark" href="${pageContext.request.contextPath}/view/user/student.jsp?page=assessment">
